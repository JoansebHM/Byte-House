...
const Sidebar = ({
  ...
  return (
    <>
          ...
          <nav className="flex flex-col gap-2">
            {menuItems.map((item) => (
              <button
                ...
                className={`cursor-pointer flex items-center gap-3 p-3 rounded-md transition-colors ${
            ...
            <div className="flex items-center justify-between p-2">
              <span className="font-inconsolata font-bold text-black dark:text-white">
                TEMA
              </span>
              <button
      ...
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:flex flex-col border-r border-black dark:border-white bg-white dark:bg-black text-black dark:text-white transition-all duration-300 h-screen sticky top-0 ${
      ...
      >
        ...
        <nav
          className={`flex-1 p-2 space-y-2 mt-4 ${
          ...
          {menuItems.map((item) => (
            <div key={item.id} className="relative group/item">
              <button
                ...
                className={`cursor-pointer flex items-center gap-3 p-3 rounded-md transition-colors w-full ${
                  activeSection === item.id
                    ? "bg-black text-white dark:bg-white dark:text-black"
                    : "text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800"
        ...
        <div className="p-2 border-t border-black dark:border-white space-y-2">
          {!isCollapsed ? (
            <button
              onClick={toggleDarkMode}
              className="cursor-pointer flex items-center gap-3 p-3 w-full rounded-md text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors"
            >
              {darkMode ? <Sun size={20} /> : <Moon size={20} />}
              <span className="font-inconsolata font-bold">
            ...
            <button
              onClick={toggleDarkMode}
              className="cursor-pointer flex items-center justify-center p-3 w-full rounded-md text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors"
