    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col">
                ...
                <button
                    className="w-full mt-auto py-2 px-4 bg-white dark:bg-black border border-black dark:border-white text-black dark:text-white font-inconsolata font-bold hover:bg-white hover:text-black dark:hover:bg-white dark:hover:text-black transition-colors"
                >
                    VER DETALLES
                </button>
            </div>
